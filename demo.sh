...
echo "Categories:"
echo "  • System Administration: 12 scripts"
echo "  • DevOps & CI/CD: 8 scripts"
echo "  • Monitoring & Alerting: 11 scripts"
echo "  • Backup & Recovery: 10 scripts"
echo "  • Container & Kubernetes: 7 scripts"
echo "  • Security & Compliance: 5 scripts"
echo "  • Git & Developer Productivity: 3 scripts"
echo "  • Utilities: 2 scripts"
echo ""
